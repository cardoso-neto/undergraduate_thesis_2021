...
% social media began as toys
% social media evolved to be used by millions all the time
...
% "precisamos de um corpo legal para controlar isso"
...
Técnicas de endereçamento são utilizadas para referenciar ou apontar (\textit{link}) arquivos na web.
...
% faltou ref a figura no texto
\begin{figure}[htb!]
\centering\includegraphics[width=.65\textwidth]{fig/Memo.jpg}
...
\tabularnewline Memo              &  pay-to-use  & Distribuída      &  &  Resistente à Censura   \tabularnewline Twetch            &  pay and earn  & interface centralizada, dados distribuídos &  &  Resistente à Censura*       
\end{tabular}}
\end{center}
\end{table}
