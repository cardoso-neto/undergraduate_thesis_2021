...
\begin{figure}[htb!]
\centering
\includesvg[width = .2\textwidth]{fig/Facebook_icon.svg}
...
\begin{figure}[htb!]
\centering
\includesvg[width = .4\textwidth]{fig/4chan_logo.svg}
...
\begin{figure}[htb!]
\centering
\includesvg[width = .25\textwidth]{fig/Diaspora_logo.svg}
...
\begin{figure}[htb!]
\centering
\includesvg[width = .3\textwidth]{fig/twitch_logo.svg}
...
\begin{figure}[H]
\centering
\includegraphics[width=.55\textwidth]{fig/Memo.jpg}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=.35\textwidth]{fig/profit.png}
