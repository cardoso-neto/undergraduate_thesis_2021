...
Through an analysis of current social media focused on their data management design decision, we identified problems with a common cause: them being walled gardens.
Therefore, we propose, thanks to the data we gathered on our analysis, a set of tools capable of upgrading their centralized web 2 software architecture to a decentralized web3-based one.
This upgrade would happen by way of migrating the data to an open network, breaking down the garden walls.
In order to accomplish that, we will enlist the help of tools such as webscraping, peer-to-peer networking, and public-key cryptography.
\end{abstract}
