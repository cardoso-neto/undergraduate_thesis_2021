...
\title{Descentralizando Mídias Sociais da Web 2.0}
      {Decentralizing Social Media of the Web 2.0}
...
%Este trabalho expõe os problemas das redes sociais advindos de serem plataformas fechadas e propõe uma estratégia para mitigá-los.Sugerindo soluções de forma isolada e, por fim, concretizaremos nossa estratégia com o desenvolvimento de uma solução que faça a transição do modelo atual , Web 2.0 , para  uma nova arquitetura de software, Web 3.0 , que vise superar as limitações da anterior.
...
%Tudo isso com o objetivo de identificar melhorias na forma de circulação de dados numa rede social, otimizando o tráfego e a identificação de dados na redes como também dando aos usuários o poder de ação sobre os seus dados.
\end{resumo}
